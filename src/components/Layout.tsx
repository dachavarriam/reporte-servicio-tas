...
export function Layout() {
  ...
  return <div className="shell">
    ...
    <div className="app-area">
      ...
      <main><Outlet /></main>
      <nav className="bottom-nav"><NavLink to="/" end><Home /><span>Reportes</span></NavLink><NavLink to="/pendientes"><Clock3 /><span>Pendientes</span></NavLink><button onClick={() => navTo(`/nuevo?draft=${Date.now()}`)}><Plus /></button><NavLink to="/perfil"><UserRound /><span>Perfil</span></NavLink></nav>
    </div>
